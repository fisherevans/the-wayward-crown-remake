...
public class GFX {
     ...
     * @param x the x topLeftPosition of the top left of the text
     * @param y the y topLeftPosition of the top left of the text
    ...
    /**
     * draw a text box on the screen at a given topLeftPosition and alignment
     * @param x x pos of the top left of the text box
